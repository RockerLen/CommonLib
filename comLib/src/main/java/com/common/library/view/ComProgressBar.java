...
import com.common.library.widget.BootstrapBrand;
import com.common.library.widget.BootstrapBrandView;
import com.common.library.widget.BootstrapSizeView;
import com.common.library.widget.DefaultBootstrapBrand;
import com.common.library.widget.ProgressView;
import com.common.library.widget.RoundableView;
 ...
 */
public class ComProgressBar extends View implements ProgressView, BootstrapBrandView,
    ...
    private void initialise(AttributeSet attrs) {
        ...
        // get attributes
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ComProgressBar);

        try {
            this.animated = a.getBoolean(R.styleable.ComProgressBar_animated, true);
            this.rounded = a.getBoolean(R.styleable.ComProgressBar_roundedCorners, true);
            this.striped = a.getBoolean(R.styleable.ComProgressBar_striped, false);
            this.showPercentage = a.getBoolean(R.styleable.ComProgressBar_bootstrapshowPercentage, false);
            this.userProgress = a.getInt(R.styleable.ComProgressBar_bootstrapProgress, 0);
            this.maxProgress = a.getInt(R.styleable.ComProgressBar_bootstrapMaxProgress, 100);
            this.progressColor = a.getColor(R.styleable.ComProgressBar_progressColor, ColorUtils.resolveColor(R.color.bootstrap_brand_primary, getContext()));
            this.progressBackgroundColor = a.getColor(R.styleable.ComProgressBar_progressBackgroundColor, ColorUtils.resolveColor(R.color.bootstrap_gray_light, getContext()));
            this.bootstrapSize = DefaultBootstrapSize.fromAttributeValue(-1).scaleFactor();
            this.bootstrapBrand = DefaultBootstrapBrand.fromAttributeValue(-1);
        ...
        bgPaint.setColor(progressBackgroundColor);
