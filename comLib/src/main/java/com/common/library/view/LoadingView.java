...
public class LoadingView extends View {
    ...
    public LoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSize = array.getDimensionPixelSize(R.styleable.LoadingView_loading_size, DimenUtils.dpToPixels(32));
        mPaintColor = array.getInt(R.styleable.LoadingView_loading_color, Color.WHITE);
        array.recycle();
        initPaint();
    }
